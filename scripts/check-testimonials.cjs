...
assert(track.innerHTML.includes('Vezi recomandarea pe Facebook'), 'Render Facebook review source correctly');
assert(track.innerHTML.includes('4307341192816609'), 'Render Loredana Facebook post link');
