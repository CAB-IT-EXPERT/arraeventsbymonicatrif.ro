(function () {
  ...
  function renderAutomation(category) {
    ...
    return `<section class="category" id="category-${category.id}">
      ...
      <section class="bundle export-bundle"><header><div><h3>Exporturi Excel &amp; PDF</h3><p>50 lei pentru fiecare secțiune, cu plafon automat de 200 lei pentru pachetul complet.</p></div><div class="bundle-header-badges"><span class="mini-badge">${icon('spark')} Recomandat CAB-IT</span><span class="bundle-price-badge">${exports.length ? lei(exportCost) : 'Neselectat'}</span></div></header>
